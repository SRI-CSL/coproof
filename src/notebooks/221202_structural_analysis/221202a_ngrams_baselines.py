...
"""Applies simplet5 setup, but uses a baseline classifiers.  This adjusts by running different patterns of
ngrams in the tfidf vectorizer
...
# In[ ]:
print("Conducting analyses with ngram_range={}".format(NGRAM_RANGE))
